...
#import "C2FileManager.h"
#import "C2Context.h"
#import "C2LoadingHUD.h"
#import "C2DBManager.h"
...
#define ImageContentName(X) ([UIImage c2_imageNamed:X])
...
#define TEXT_COLOR kColorFromRGB(0x3B3B3B)
#define SUBTEXT_COLOR kColorFromRGB(0xB9B9B9)
#define OTHERSUBTEXT_COLOR kColorFromRGB(0x999999)
#define BACKGROUND_GRAY_COLOR kColorFromRGB(0xF2F2F2)//10PX 填充的
#define BACKGROUND_BLACK_COLOR kColorFromRGBA(0x000000, 0.5)
#define BACKGROUND_BLUE_COLOR kColorFromRGB(0x0085FF)
#define TABBAR_GARY_COLOR kColorFromRGB(0x28435D)
#define CELL_LINE_COLOR kColorFromRGB(0xE2E6E8)//1PX cell下的线
#define SELECTED_COLOR kColorFromRGB(0xED9D2C)
#define NEED_TO_CHANGE_COLOR kColorFromRGB(0x000000)

#define MESSAGE_LINE_COLOR kColorFromRGB(0xE5E5E5)
#define MESSAGE_BLUE_COLOR kColorFromRGB(0x3296FA)
#define MESSAGE_RED_COLOR kColorFromRGB(0xF25642)
#define MESSAGE_UNREADBACK_COLOR kColorFromRGB(0xF83636)
...
// 登录成功跳转首页
#define kLoginSuccessAndJumpToHomePage @"kLoginSuccessAndJumpToHomePage"

//用户未登录，跳转登录界面
#define kNotifacation_UserUnauthorized @"kNotifacation_UserUnauthorized"

//用户信息更新
#define kNotification_UserInfoUpdated @"kNotification_UserInfoUpdated"

//未读消息数获取
#define kNotification_unreadMsgCntNeedUpdate @"kNotification_unreadMsgCntNeedUpdate"

//强制横屏
#define kNotifacation_ForceLandscape @"kNotifacation_ForceLandscape"
